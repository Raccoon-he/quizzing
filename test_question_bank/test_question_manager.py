...
class TestQuestionManager(unittest.TestCase):
    ...
    def test_add_question(self):
        self.assertEqual(len(qm.question_bank), 0)
        self.manager.add_question(self.questions[0])
        self.assertEqual(len(qm.question_bank), 1)
        self.assertEqual(qm.question_bank[0]['id'], 20)
        ...
        self.assertEqual(len(qm.question_bank), 5)
        self.assertEqual(qm.question_bank[4]['id'], 24)

    def test_remove_question(self):
        self.manager.remove_question(20)
        self.assertEqual(len(qm.question_bank), 4)
        self.assertEqual(qm.question_bank[3]['id'], 24)
        self.manager.remove_question(24)
        self.assertEqual(len(qm.question_bank), 3)
        self.assertEqual(qm.question_bank[2]['id'], 23)
